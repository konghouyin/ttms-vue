    ...
    <div class="banner">
      <div class="faimg">
        ...
        <div class="nei">
          ...
          <div class="action">
            <div class="wish" @click="love=!love"> <el-image :src="isrc[rate?1:love?1:0]" style="width: 16px;height: 16px; margin-right: 2px;" ></el-image>{{rate?'已看':love?'已想看':'想看'}}</div>
            <div class="wish" @click="centerDialogVisible = true"> <el-image :src="isrc[rate?3:2]" style="width: 16px;height: 16px; margin-right: 2px;" ></el-image>{{rate?'已评,'+mark2*2+'分':'评分'}}</div>
      ...
      <div class="clear" style="min-width: 1200px;">
        ...
        <div style="width: 730px; ">
          ...
          <el-dialog :visible.sync="centerDialogVisible" width="550px" center>
            ...
            <el-button :disabled="textarea===''? true:mark2===0" type="danger" style="margin-top: 20px; margin-left: 430px;"  @click="open('评价成功','您评分'+mark2*2+'分:'+textarea),centerDialogVisible = false,rate = true">确 定</el-button>
